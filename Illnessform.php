...
if(isset($_POST['addillness'])){
    addillness($_POST['illness'],$_POST['description']);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">New Illness</h1>
                ...
                <div class="col-lg-12 pt-2">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Illness Add Form</h6>
                        </div>
                        <div class="card-body">
                            <form class="user" action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="illness" name="illness" placeholder="Illness" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <button type="submit" id="addillness" name="addillness" class="btn btn-primary btn-sm"><i class="fas fa-external-link-alt"></i> Add New Illness</button>
                            </form>
                        </div>
                    </div>
                </div>
