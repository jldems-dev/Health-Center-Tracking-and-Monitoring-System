...
$prenatalpr=mysqli_query($db, "SELECT * FROM prenatal_patients_record WHERE prenatal_patient_id='$prenatalpatientid'");
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-bordered" id="tablepi">
                                        <thead>
                                            <tr>
                                                <th colspan="4" id="pi">Prenatal Patient Record</th>
                                            </tr>
                                            <?php
                                            while($rowppr = mysqli_fetch_assoc($prenatalpr)){
                                            ?>
                                            <tr>
                                                <th id="thprint">Visit: <?php echo $rowppr['status_visit'];?></th>
                                                <th id="thprint">Quarter: <?php echo $rowppr['quarter'];?></th>
                                                <th id="thprint">Concern: <?php echo $rowppr['concern'];?></th>
                                                <th id="thprint">Date Visit: <?php echo $rowppr['date_visit'];?></th>
                                            </tr>
                                            <?php
                                            }
                                            ?>
