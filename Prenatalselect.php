...
if(isset($_POST['selectpatients'])){
    selectpatientsprenatal($_POST['prenatalid'], $_POST['patientid']);
}
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $num=1;
                                        $patient = mysqli_query($db,"SELECT * FROM patient WHERE status='Adult'");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $rowp['bp'];?></td>
                                            <td><?php echo $rowp['temp'];?> ℃</td>
                                            <td><?php echo $rowp['wt'];?> kg.</td>
                                            <td>
                                                <?php
                                                $immunep=mysqli_query($db,"SELECT * FROM prenatal_patients WHERE patients_id='".$rowp['id']."'");
